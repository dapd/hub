...
Inicializa a instância da classe e se conecta ao firebase. 

Altere a inicialização self.\+\_\+\+\_\+config apropriadamente. Esse método conecta-\/se com o firebase, seta o status do hub atual para ON, e, caso o hub já tenha um dono, começa a escutar as mensagens do app.

Exemplo de uso\+:


\begin{DoxyCode}
1 foo = HubParaFirebase(\textcolor{stringliteral}{"kasldjlasjdl"})
\end{DoxyCode}
...
{\em self} & O objeto \\
\hline
{\em hub\+ID} & O id do hub. É esperado que seja válido. Ver \hyperlink{classhub_para_firebase_1_1_hub_para_firebase}{Hub\+Para\+Firebase} para mais detalhes. \\
\hline
\end{DoxyParams}
